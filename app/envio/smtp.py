...
def _armar_mensaje(remitente_nombre: str, remitente: str, destinatarios: list[str],
                   ...
                   adjuntos: Optional[list[str]] = None, in_reply_to: Optional[str] = None) -> EmailMessage:
    msg = EmailMessage()
    ...
    # Responder EN EL MISMO HILO: encadena con el Message-ID del último mensaje del ticket.
    if in_reply_to:
...
class Emisor(Protocol):
    ...
    def enviar(self, destinatarios: list[str], asunto: str, cuerpo_texto: str,
               cc: Optional[list[str]] = None, adjuntos: Optional[list[str]] = None,
               hilo_id: Optional[str] = None, in_reply_to: Optional[str] = None) -> dict: ...
...
class EmisorLaboratorio:
    ...
    def enviar(self, destinatarios, asunto, cuerpo_texto, cc=None, adjuntos=None,
        ...
        return {"ok": True, "modo": self.modo, "simulado": True,
                ...
                "hilo_id": hilo_id, "in_reply_to": in_reply_to,
                "en_hilo": bool(hilo_id or in_reply_to)}
